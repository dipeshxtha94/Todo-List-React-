...
class Home extends Component{
    ...
    componentDidMount(){
        ...
        .catch((error)=>{
            toast('ERROR DISPLAYING BLOGS(2)')
    ...
    render(){ 
        ...
        <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="gallery-updates cols2 clearfix">
                                ...
                                <div class="gallery-updates-overlay"> <i class="fa fa-image"></i> Updates from our gallery </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8">
                            <div class="carousel-wrapper">
                                <div class="row">
                                    <ul class="owl-carousel carousel-fw owl-theme" id="news-slider" data-columns="2" data-autoplay="" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="1" data-items-mobile="1"> { this.state.blogs.map((blog)=>{ return(
                                        <li class="item" style={{float: "left"}}>
                                            <div class="grid-item blog-grid-item format-standard">
                                                <div class="grid-item-inner">
                                                    <a href={ '/single-post/' + blog._id} class="media-box"> <img src={blog.blogImage} class="height240width360" alt="" /> </a>
                                                    <div class="grid-item-content">
                                                        <h3 class="post-title"><a href={'/single-post/' + blog._id}>{blog.blogTitle}</a></h3> <span class="meta-data">Posted on 11th Dec, 2015</span> </div>
                                                </div>
                                            </div>
                                        </li> )})} </ul>
                                </div>
            ...
            <div class="accent-bg padding-tb20 cta-fw">
                <div class="container"> <a href="/become-a-volunteer" class="btn btn-default btn-rounded pull-right">Become a volunteer</a>
                    <h4>Let's start doing your bit for the world. Join us as a Volunteer</h4> </div>
            </div>
            <Footer></Footer>
        </div> 
        )
